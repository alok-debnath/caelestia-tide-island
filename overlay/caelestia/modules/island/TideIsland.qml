...
// window out of the overlay is what makes upstream bumps a reinstall instead
// of a merge. See docs/ARCHITECTURE.md.
import "file:/usr/share/tide-island" as Tide
